...
<table width="550" bgcolor="#1EABDF" style="border: 1px solid #000000;">
   <tr>
      <td>
         <p align="center" style="font-size: 18px"><font color="#FFFFFF">POP3 Settings</font></p>
      </td>
   </tr>
</table>
<table border="0" width="550" bgcolor="#F0F0F0" style="border: 1px solid #000000;">
   <tr>
   ...
   <tr><td colspan="5"><hr style="border: 0; background-color: #666666; color: #666666; height: 1px; width: 100%;"></td></tr>
   <tr>
   ...
   <tr>
      <td colspan="5">
         <table cellpadding="0" cellspacing="0" border="0" align="right"><tr><td>
            ...
            <input class="button-primary" type="submit" name="Save"    value="Save" alt="Save">
