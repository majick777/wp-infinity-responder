...
<br />
<center>
<table border="0" cellspacing="2" cellpadding="0" width="550" bgcolor="#1EABDF" style="border: 1px solid #000000;">
   <tr>
      <td>
         <p align="center" style="font-size: 18px"><font color="#FFFFFF">
            Delete Bouncer
         </font></p>
      </td>
   </tr>
</table>
<table border="0" cellspacing="2" cellpadding="0" width="750" bgcolor="#F0F0F0" style="border: 1px solid #000000;">
      ...
      <td colspan="2">
         <table align="left" cellpadding="10" cellspacing="0"><tr><td>
            ...
            <FORM action="" method=GET>
               ...
               <input type="hidden" name="b_ID"   value="<?php echo $bouncer_id; ?>">
               <input class="button-secondary" type="submit" name="No"     value="No" class="butt">
            </FORM>
         </td></tr></table>
      </td>
   </tr>
